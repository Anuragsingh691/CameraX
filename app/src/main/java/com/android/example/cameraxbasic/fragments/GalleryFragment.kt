    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        view.findViewById<ImageButton>(R.id.delete_button).setOnClickListener {
            ...
            mediaList.getOrNull(mediaViewPager.currentItem)?.let { mediaFile ->
                ...
                if((mediaFile.name.get(12).toInt())>=2)
                {
                    AlertDialog.Builder(view.context, android.R.style.Theme_Material_Dialog)
                            .setTitle("Date "+mediaFile.name.subSequence(0,10).toString()+"\n"+"Time "+mediaFile.name.subSequence(11,13).toString()+":"+mediaFile.name.subSequence(14,16).toString())
                            .setMessage("Storage path \n"+mediaFile.path)
                    ...
                    AlertDialog.Builder(view.context, android.R.style.Theme_Material_Dialog)
                            .setTitle("Date "+mediaFile.name.subSequence(0,10).toString()+"\n"+"Time "+mediaFile.name.subSequence(11,16).toString())
                            .setMessage("Storage path \n"+mediaFile.path)
                            .setIcon(android.R.drawable.ic_dialog_info)
                            .setPositiveButton(android.R.string.yes) { _, _ ->
